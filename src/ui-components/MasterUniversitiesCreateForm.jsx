...
export default function MasterUniversitiesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MasterUniversities(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MasterUniversitiesCreateForm")}
      {...rest}
    >
      <TextField
