export const schema = {
      ...
      fields: {
        ...
        adminLogs: {
          ...
          association: {
            ...
            associatedWith: ["applicationAdminLogsId"],
          },
        },
        studentLogs: {
          name: "studentLogs",
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["applicationStudentLogsId"],
          },
        },
        attachment: {
          name: "attachment",
          ...
          association: {
            ...
            associatedWith: ["id"],
            targetNames: ["applicationAttachmentId"],
          },
        },
        programs: {
          name: "programs",
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["applicationProgramsId"],
          },
        },
        dateTime: {
          name: "dateTime",
      ...
      attributes: [
        ...
        },
        {
          ...
          properties: {
            ...
            fields: ["nationalityCategory", "batch"],
          },
        },
        {
          type: "key",
    ...
    Program: {
      ...
      fields: {
        ...
        applications: {
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["programApplicationsId"],
          },
        },
        isDeactivated: {
          name: "isDeactivated",
        ...
        application: {
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["programApplicationId"],
          },
        },
        createdAt: {
          name: "createdAt",
    ...
    University: {
      ...
      fields: {
        ...
        Programs: {
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["universityProgramsId"],
          },
        },
        availability: {
          name: "availability",
        ...
        applications: {
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["universityApplicationsId"],
          },
        },
        createdAt: {
          name: "createdAt",
      ...
      attributes: [
        ...
        },
        {
          ...
          properties: {
            ...
            fields: ["masterApplicationAdminLogsId"],
          },
        },
        {
          type: "auth",
      ...
      attributes: [
        ...
        },
        {
          ...
          properties: {
            ...
            fields: ["applicationStudentLogsId"],
          },
        },
        {
          type: "auth",
    ...
    Admin: {
      ...
      fields: {
        ...
        AdminLogs: {
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["adminAdminLogsCpr"],
          },
        },
        role: {
          name: "role",
    ...
    Student: {
      ...
      fields: {
        ...
        StudentLogs: {
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["studentStudentLogsCpr"],
          },
        },
        m_MasterLogs: {
          name: "m_MasterLogs",
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["studentM_MasterLogsCpr"],
          },
        },
        m_firstName: {
          name: "m_firstName",
      ...
      attributes: [
        ...
        },
        {
          ...
          properties: {
            name: "byNationalityCategory",
            fields: ["nationalityCategory", "graduationDate"],
          },
        },
        {
          type: "key",
    ...
    Statistics: {
      ...
      attributes: [
        ...
        },
        {
          ...
          properties: {
            name: "byBatch",
            fields: ["batch", "totalApplications"],
          },
        },
        {
          type: "auth",
      ...
      attributes: [
        ...
        },
        {
          ...
          properties: {
            ...
            fields: ["masterApplicationMasterLogsId"],
          },
        },
        {
          type: "auth",
    ...
    MasterApplication: {
      ...
      fields: {
        ...
        adminLogs: {
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["masterApplicationAdminLogsId"],
          },
        },
        masterLogs: {
          name: "masterLogs",
          ...
          association: {
            connectionType: "HAS_MANY",
            associatedWith: ["masterApplicationMasterLogsId"],
          },
        },
        attachment: {
          name: "attachment",
          ...
          association: {
            connectionType: "HAS_ONE",
            associatedWith: ["id"],
            targetNames: ["masterApplicationAttachmentId"],
          },
        },
        program: {
          name: "program",
  ...
  enums: {
    ...
    ApplicantType: {
      name: "ApplicantType",
      values: ["STUDENT", "MASTER"],
    },
    Income: {
      name: "Income",
      values: ["LESS_THAN_1500", "MORE_THAN_1500"],
    },
    Major: {
      name: "Major",
      values: ["SCIENCE", "TECHNOLOGY", "ENGINEERING"],
    },
  },
  nonModels: {},
