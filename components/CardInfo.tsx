...
export const CardInfoComponent: FC<Props> = (props) => {
  return (
    <div className="flex flex-col items-center justify-between w-full max-w-sm p-8 prose text-center bg-white shadow rounded-3xl prose-h1:font-semibold prose-h1:text-2xl shadow-base-200 card">
