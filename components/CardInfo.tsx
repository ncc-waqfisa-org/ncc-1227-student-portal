...
export const CardInfoComponent: FC<Props> = (props) => {
  return (
    <div className="flex flex-col justify-between items-center p-8 w-full max-w-sm h-full text-center bg-white rounded-3xl shadow prose prose-h1:font-semibold prose-h1:text-2xl shadow-base-200 card">
